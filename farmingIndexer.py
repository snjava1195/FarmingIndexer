...
async def get_body(request: Request):
    ...
    response = requests.post("https://farming-pool-indexer.broxus.com/v1/farming_pools", json=json1)
...
async def get_body(request:Request, farming_pool_address: str):
    json1 = await request.json()
    response = requests.post("https://farming-pool-indexer.broxus.com/v1/farming_pools/" + farming_pool_address, json=json1)
    return response.json()
...
async def get_body(request: Request):
    json1 = await request.json()
    response = requests.post("https://farming-pool-indexer.broxus.com/v1/graphic/tvl", json=json1)
    return response.json()
...
async def get_body(request: Request):
    json1 = await request.json()
    response = requests.post("https://farming-pool-indexer.broxus.com/v1/graphic/apr", json=json1)
    return response.json()
...
async def get_body(request: Request):
    json1 = await request.json()
    response = requests.post("https://farming-pool-indexer.broxus.com/v1/transactions", json=json1)
    return response.json()
